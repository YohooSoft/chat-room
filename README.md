...
English: A front-end multi-character AI chatroom prototype built with Angular, codenamed AI Drama Engine, using Haiku to generate ExecutionPlan.
...
默认使用 `ai-drama-engine` 作为 key（系统代号的 kebab-case 写法），结构如下：
